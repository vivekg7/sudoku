...
void main() {
  group('StatsStore', () {
    ...
    test('records games and counts', () {
      store.record(makeGame(id: '1'));
      store.record(makeGame(id: '2', completed: false));
    ...
    test('completion rate', () {
      store.record(makeGame(id: '1'));
      store.record(makeGame(id: '2', completed: false));
      store.record(makeGame(id: '3'));

      expect(store.completionRate, closeTo(2 / 3, 0.001));
    });

    test('average and best solve time', () {
      store.record(makeGame(id: '1', time: 200));
      store.record(makeGame(id: '2', time: 100));
      store.record(makeGame(id: '3', completed: false, time: 50));
    ...
    test('longest streak', () {
      store.record(makeGame(id: '1'));
      store.record(makeGame(id: '2'));
      store.record(makeGame(id: '3'));
      store.record(makeGame(id: '4', completed: false));
      store.record(makeGame(id: '5'));

      expect(store.longestStreak, 3);
    });

    test('games by difficulty', () {
      store.record(makeGame(id: '1', difficulty: Difficulty.easy));
      store.record(makeGame(id: '2', difficulty: Difficulty.easy));
      store.record(makeGame(id: '3', difficulty: Difficulty.hard));
    ...
    test('average time by difficulty', () {
      store.record(
          makeGame(id: '1', difficulty: Difficulty.easy, time: 100));
      store.record(
          makeGame(id: '2', difficulty: Difficulty.easy, time: 200));
    ...
    test('JSON round-trip preserves all games', () {
      store.record(makeGame(id: '1', time: 100));
      store.record(makeGame(id: '2', time: 200, completed: false));
